...
parser.add_argument(
    "--data_dir", type=str, default="Code with Plackett Luce/nails-main/data", help="Path to data directory"
)

parser.add_argument(
    "--project_root",
    type=str,
    default=r"C:/Users/Mikkel/OneDrive/Universitet/Bachelorprojekt/Code with Plackett Luce",
    help="Root directory where plot/ and data/ebnerd_submissions outputs are saved",
)

parser.add_argument(
    "--score_dir",
    type=str,
    default="Code with Plackett Luce/nails-main/data/test_scores.parquet", #default="data/test_scores.parquet"
    help="Path to score file",
)
parser.add_argument(
    "--emb_dir",
    type=str,
    default="Code with Plackett Luce/nails-main/data/Ekstra_Bladet_contrastive_vector/contrastive_vector.parquet",
