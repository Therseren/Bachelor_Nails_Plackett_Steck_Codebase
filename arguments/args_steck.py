...
parser.add_argument(
    "--data_dir", type=str, default="nails-main/data", help="Path to data directory"
)
parser.add_argument(
    "--score_dir",
    type=str,
    default="nails-main/data/test_scores_demo.parquet",
    help="Path to score file",
)
parser.add_argument(
    "--emb_dir",
    type=str,
    default="nails-main/data/Ekstra_Bladet_contrastive_vector/contrastive_vector_demo.parquet",
